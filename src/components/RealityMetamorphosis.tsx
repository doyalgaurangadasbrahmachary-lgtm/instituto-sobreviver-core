        ...
        return (
            <section id="reality-metamorphosis" className="relative w-full bg-black">
                ...
                {SECTIONS.flatMap((section) => [
                    // Bloque B&N — texto del problema (bidireccional)
                    <MobileScrollBlock
                        key={`${section.id}-bn`}
                        imgSrc={section.imgBN.mobile}
                    ...
                    />,
                    // Bloque Color — texto de esperanza (bidireccional, último persistente)
                    <MobileScrollBlock
                        key={`${section.id}-color`}
                        imgSrc={section.imgColor.mobile}
